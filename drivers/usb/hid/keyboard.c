...
uint16_t hid_keyboard_to_input_key[] = {
  ...
  [HID_KEYBOARD_LSQUARE] = KEY_LEFTBRACE,
  [HID_KEYBOARD_RSQUARE] = KEY_RIGHTBRACE,
  ...
  [HID_KEYBOARD_PRINTSCR] = KEY_SYSRQ,
  [HID_KEYBOARD_SCROLL_LOCK] = KEY_SCROLLLOCK,
  [HID_KEYBOARD_PAUSE] = KEY_PAUSE,
  [HID_KEYBOARD_INSERT] = KEY_INSERT,
  [HID_KEYBOARD_HOME] = KEY_HOME,
  [HID_KEYBOARD_PAGE_UP] = KEY_PAGEUP,
  [HID_KEYBOARD_DELETE_FWD] = KEY_DELETE,
  [HID_KEYBOARD_END] = KEY_END,
  [HID_KEYBOARD_PAGE_DOWN] = KEY_PAGEDOWN,
  [HID_KEYBOARD_RIGHT] = KEY_RIGHT,
  [HID_KEYBOARD_LEFT] = KEY_LEFT,
  [HID_KEYBOARD_DOWN] = KEY_DOWN,
  [HID_KEYBOARD_UP] = KEY_UP,
  [HID_KEYBOARD_NUM_LOCK] = KEY_NUMLOCK,
  [HID_KEYBOARD_KP_SLASH] = KEY_KPSLASH,
  [HID_KEYBOARD_KP_ASTERISK] = KEY_KPASTERISK,
  [HID_KEYBOARD_KP_MINUS] = KEY_KPMINUS,
  [HID_KEYBOARD_KP_PLUS] = KEY_KPPLUS,
  [HID_KEYBOARD_KP_ENTER] = KEY_KPENTER,
  [HID_KEYBOARD_KP_1] = KEY_KP1,
  [HID_KEYBOARD_KP_2] = KEY_KP2,
  [HID_KEYBOARD_KP_3] = KEY_KP3,
  [HID_KEYBOARD_KP_4] = KEY_KP4,
  [HID_KEYBOARD_KP_5] = KEY_KP5,
  [HID_KEYBOARD_KP_6] = KEY_KP6,
  [HID_KEYBOARD_KP_7] = KEY_KP7,
  [HID_KEYBOARD_KP_8] = KEY_KP8,
  [HID_KEYBOARD_KP_9] = KEY_KP9,
  [HID_KEYBOARD_KP_0] = KEY_KP0,
  [HID_KEYBOARD_KP_PERIOD] = KEY_KPDOT,
  [HID_KEYBOARD_NON_US_BACKSLASH] = KEY_BACKSLASH,
  [HID_KEYBOARD_APPLICATION] = KEY_COMPOSE,
  [HID_KEYBOARD_POWER] = KEY_POWER,
  [HID_KEYBOARD_KP_EQUAL] = KEY_KPEQUAL,
  ...
  [HID_KEYBOARD_VOLUME_UP] = KEY_VOLUMEUP,
  [HID_KEYBOARD_VOLUME_DOWN] = KEY_VOLUMEDOWN
};

uint16_t hid_modifier_bit_to_input_key[] = {
  [HID_BIT_LCONTROL] = KEY_LEFTCTRL,
  [HID_BIT_LSHIFT] = KEY_LEFTSHIFT,
  [HID_BIT_LALT] = KEY_LEFTALT,
  [HID_BIT_LSPECIAL] = KEY_LEFTMETA,
  [HID_BIT_RCONTROL] = KEY_RIGHTCTRL,
  [HID_BIT_RSHIFT] = KEY_RIGHTSHIFT,
  [HID_BIT_RALT] = KEY_RIGHTALT,
  [HID_BIT_RSPECIAL] = KEY_RIGHTMETA,
};
